...
const thinhMessages = [
 "Con bốc được lá 2 ♥ Để Thầy xem...Uhmm, một quân bài rất tốt. Nó báo hiệu rằng con sẽ được người yêu hoặc một người mến mộ ủng hộ và giúp đỡ. Thế nên là an tâm con nhá, có khó khăn gì thì người ấy cũng thông cảm và giúp con mà.",
...
const replyMessage = await message.reply(`${thinhMessage}`);
