import { VoteLynch } from '../ability/index.js';
import { FunnyDeaths } from '../constant/index.js';
import { Party, DeathType } from '../enum/index.js';
import * as Gang from '../gang/index.js';
import { Death } from '../type/index.js';
import { gameConfig, symbols, randomItem, vietsub } from '../helper.js';
...
export default class World extends Manager {
	...
	async onLynch() {
		...
		const votes = await Promise.all(
			alives.map(player => player.request(VoteLynch))
		);
