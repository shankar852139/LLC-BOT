...
import { Isolate } from '../gang/index.js';
import { Movement } from '../type/index.js';
import { gameConfig } from '../helper.js';
...
export default class Role {
	...
	async die(death) {
		...
		let rep =
			...
			`đã hi sinh vào đêm thứ ${this.world.history.items.filter(item => item.event == 'night').length
			}!\n`;
		switch (death.type) {
			case DeathType.P2P:
